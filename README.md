...
## Data Analyst → ML Engineer | Nairobi, Kenya 🇰🇪

---

I build data solutions with a focus on machine learning,
healthcare AI, and business analytics. Currently on a
structured journey from Data Analyst to ML Engineer —
building in public, one notebook at a time.

<img align="right" alt="Coding" width="300"
src="https://raw.githubusercontent.com/TheDudeThatCode/TheDudeThatCode/master/Assets/Developer.gif">

* 📍 Based in Nairobi, Kenya
* ✉️ Contact: [ngangam93@gmail.com](mailto:ngangam93@gmail.com)
* 🔭 Currently building: ML learning notebooks + 3 portfolio projects
* 🌱 Learning: Neural Networks · GenAI · RAG Systems · Google Cloud
* 💼 Background: Healthcare AI · Digital Transformation · Business Analytics
...
### 🎯 Core Competencies
- **Machine Learning:** Predictive models, ensemble methods, feature engineering
...
- **Digital Transformation:** Process automation, change management
- **Project Management:** Budget management, stakeholder coordination
...
`Python` `scikit-learn` `SMOTE` `FastAPI` `Kaggle`
> ⏳ In Progress
...
`Python` `LangChain` `FAISS` `Anthropic API` `HuggingFace`
> ⏳ Coming Soon
