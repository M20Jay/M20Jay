...
<img src="https://readme-typing-svg.demolab.com?font=Playfair+Display&size=22&duration=3500&pause=2000&color=4169E1&center=false&vCenter=true&width=800&height=60&lines=Building+ML+systems+for+Africa%27s+most+urgent+problems.;From+Nairobi%2C+for+the+world.;Data+is+only+as+powerful+as+the+institution%27s+willingness+to+act+on+it." alt="Typing SVG" />
