...
| **05** | Credit Risk Scoring + Propensity + RFM + Loan Portfolio Analysis | XGBoost · SHAP · ADASYN · DVC · RFM · FastAPI · PostgreSQL · Grafana · Docker | ✅ [Live API](http://3.67.15.230:8005/docs) · [Repo](https://github.com/M20Jay/credit-risk-scoring-pipeline) · [Notes](https://github.com/M20Jay/credit-risk-scoring-pipeline/blob/main/notes/WEEK_05_NOTES.md) |
...
> ✅ Complete · Week 6 · Tests: 10/10 passing · [Live Dashboard](https://dashboard.martin-mlops.com) · [Live API](http://3.67.15.230:8000/docs) · [Repository](https://github.com/M20Jay/air-quality-anomaly-detection)
